    ...
    <div className="min-h-screen bg-canvas">
      ...
      <main className="max-w-6xl mx-auto px-4 pb-[calc(4rem+env(safe-area-inset-bottom))]">
        ...
        <div className="mt-8 mb-6">
          <h1 className="text-section font-bold text-light mb-1">All Reports</h1>
        ...
        {showAreaPanel && (
          <AreaFilterPanel
            active={!!areaFilter}
            onApply={(a) => { setAreaFilter(a); setShowAreaPanel(false); setAutoSet(false) }}
            onClear={() => { setAreaFilter(null); setAutoSet(false) }}
          />
        )}
                  ...
                  <div className="p-4">
                    ...
                    <div className="flex gap-2">
                      ...
                      <Button
                        variant="secondary"
                        size="sm"
                        className={isResolved ? 'w-full' : 'flex-1'}
